                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align:center">
                                                <?php 
                                                    ...
                                                    {
                                                ?>          
                                                        <a href="<?= base_url()?>pesanmodel/detail_pesan/<?= $list->no_model ?>" class="btn btn-info btn-bordered btn-xs btn-block" ><i class="fa fa-american-sign-language-interpreting"></i> Pesan Jahit  </a>
